...
* The parameters and method descriptions are not up to date.

## Features
* Calculate the power of a kite of a certain size for given environmental conditions [1].
...
* Option 2 produces an operational envelope of the pumping kite for sols (combined results shown [here](doc/Operational_envelope_kite.png)).
...
* Examples: instead of updating the density of each sol through the Python classes, a value from a list with 669 points should be used.
* Instead of updating the k and u Weibull parameters of each sol through the Python classes, a value from a list with 669 points should be used.
